...
update 'DH_USER' set USER_STATUS=7 where USER_NAME=wangyh10@asiainfo.com;
...
INSERT INTO DH_USER (USER_STATUS,USER_TYPE,USER_NAME,NICK_NAME,LOGIN_NAME,LOGIN_PASSWD,SUMMARY,OP_TIME) VALUES (2, 3, '国家旅游局','国家旅游局','cnta@asiainfo.com','2a2b5fc869677aaeb52324bf5bcb224d','国家旅游局','2016-03-17');
INSERT INTO DH_USER (USER_STATUS,USER_TYPE,USER_NAME,NICK_NAME,LOGIN_NAME,LOGIN_PASSWD,SUMMARY,OP_TIME) VALUES (2, 3, '韩忠朝','韩忠朝','hanzc@asiainfo.com','c4b952d713289b2c4a4720ee070649d3','亚信','2016-03-24');
update DH_USER set LOGIN_PASSWD=f6908f9f1227784b19edbebe3894a002 where USER_NAME=hanzc@asiainfo.com；

update DH_USER set NICK_NAME=‘hanzc’ where LOGIN_NAME=‘hanzc@asiainfo.com’；
update DH_USER set NICK_NAME=‘fengjun5’ where LOGIN_NAME=‘fengjun5@asiainfo.com’；
INSERT INTO DH_USER (USER_STATUS,USER_TYPE,USER_NAME,NICK_NAME,LOGIN_NAME,LOGIN_PASSWD,SUMMARY,OP_TIME) VALUES (2,3,'冯军','fengjun5','fengjun5@asiainfo.com','0a2cf42d116f55d28912e68c77b17291','亚信','2016-03-28');
INSERT INTO DH_USER (USER_STATUS,USER_TYPE,USER_NAME,NICK_NAME,LOGIN_NAME,LOGIN_PASSWD,SUMMARY,OP_TIME) VALUES (2,3,'韩忠朝','hanzc','hanzc@asiainfo.com','9766f1f372019371eafde6ef169cab36','亚信','2016-03-24');
INSERT INTO DH_USER (USER_STATUS,USER_TYPE,USER_NAME,NICK_NAME,LOGIN_NAME,LOGIN_PASSWD,SUMMARY,OP_TIME) VALUES (2,3,'华院数据技术(上海)有限公司','huayuan','penghui.li@huaat.net','636217a964d3491115250a61b302bf8f','华院数据技术（上海）有限公司（以下简称“华院数据”于2012年8月由华院分析和德盈数据合并），成立于2002年3月，是国内为数很少的以高水平的数据挖掘和数据分析为核心能力的专业服务公司。','2016-03-31');
INSERT INTO DH_USER (USER_STATUS,USER_TYPE,USER_NAME,NICK_NAME,LOGIN_NAME,LOGIN_PASSWD,SUMMARY,OP_TIME) VALUES (2,3,'成都勤智数码科技股份有限公司','qinzhi','bigdata@chinawiserv.com','46b8ee0f6d0caf0c60421cb8038af621','成都勤智数码（WiSERV Technologies）科技股份有限公司是业界领先的智能化IT服务保障专家，专注于为用户提供最佳IT运行维护管理解决方案，帮助用户有效处理IT系统管理中的各种困难和需求。','2016-03-31');
INSERT INTO DH_USER (USER_STATUS,USER_TYPE,USER_NAME,NICK_NAME,LOGIN_NAME,LOGIN_PASSWD,SUMMARY,OP_TIME) VALUES (2,3,'王昱','wangyu13','wangyu13@asiainfo.com','4a4bf4901f1d99de7d46ab4f82cff1a1','北京亚信数据有限公司互联网工具产品线','2016-04-01');
INSERT INTO DH_USER (USER_STATUS,USER_TYPE,USER_NAME,NICK_NAME,LOGIN_NAME,LOGIN_PASSWD,SUMMARY,OP_TIME) VALUES (2,5,'陶磊','taolei','taolei@asiainfo.com','4f979e87fc9e2fd5eccca9a8dc518002','亚信集团','2016-04-06');
